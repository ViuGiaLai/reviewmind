...
function App() {
  ...
  return <main>
    <header><img src="/logo_reviewmind.png" alt="ReviewMind logo" className="logo" /><p className="eyebrow">DOCUMENT REVIEW ENGINE</p><h1>ReviewMind</h1><p>Choose a profile, review the document, then inspect evidence-backed issues.</p></header>
